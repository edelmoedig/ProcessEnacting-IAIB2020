...
(
	...
	CONSTRAINT AK_Administrator_email UNIQUE lower(email),
...
(
	...
	CONSTRAINT CHK_Decision_table_name_not_only_whitespaces CHECK (name  !~ '^[[:space:]]*$'),
...
(
	...
	CONSTRAINT CHK_Decision_table_entry_condition_not_only_whitespaces CHECK (condition !~ '^[[:space:]]*$'),
	CONSTRAINT CHK_Decision_table_entry_action_not_only_whitespaces CHECK (action !~ '^[[:space:]]*$'),
